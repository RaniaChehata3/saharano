...
/**
 * Application launcher for the authentication-enabled version of the application.
 */
public class AuthAppLauncher extends Application {
    ...
    public void start(Stage stage) {
        ...
        MainAppView root = new MainAppView();
